...
if (isset($_POST['hitung'])) {
    ...
    $cek_row = mysqli_query($conn, "select * from absen where nik = $nik and tanggal like '%$tanggal%'");
    // echo 'Jumalah' . mysqli_num_rows($cek_row);

    if (mysqli_num_rows($cek_row) <= 0) {
        $_SESSION['status'] = "gagal";
        $_SESSION['message'] = "<strong>Gagal!</strong> Tidak Ada Data Untuk Diproses !";
