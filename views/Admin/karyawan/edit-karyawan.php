                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <input type="number" name="nik" required class="form-control" placeholder="Nik" value="<?php echo $d['nik'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="shift">
                                                    <option selected>Choose...</option>
                                                    <option value="Shift 1" <?php if ($d['shift'] == "Shift 1") {
                                                                                echo "selected";
                                                                            } ?>>Shift 1</option>
                                                    <option value="Shift 2" <?php if ($d['shift'] == "Shift 2") {
                                                                                echo "selected";
                                                                            } ?>>Shift 2</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="date" name="tgl_masuk" value="<?php echo $d['tgl_masuk'] ?>" required class="form-control" placeholder="Tanggal Masuk">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <input type="hidden" name="qrcode_lama" value="<?php echo $d['qrcode'] ?>" required class=" form-control">
