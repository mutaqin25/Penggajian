               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item ">
                                    <a href="../user/form-user.php" class="nav-link active">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <input type="text" name="nik" value="<?php echo $d['nik'] ?>" required class="form-control" placeholder="Nama">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" name="password" value="<?php echo $d['password'] ?>" required class="form-control" placeholder="Password">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="" class="col-sm-2 col-form-label">Level</label>
                                            <div class="col-sm-5">
                                                <select name="level" class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref">
                                                    <option>Choose...</option>
                                                    <option value="Admin" <?php if ($d['level'] == "Admin") {
                                                                                echo "selected";
                                                                            } ?>>Admin</option>
                                                    <option value="Pegawai" <?php if ($d['level'] == "Pegawai") {
                                                                                echo "selected";
                                                                            } ?>>Pegawai</option>
                                                </select>
                                            </div>
