                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <a class="btn btn-success" role="button" target="_blank" href="data_karyawan.php">Excel</a>
                            <a class="btn btn-primary" role="button" target="_blank" href="pdf-karyawan.php">PDF</a>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <form action="cetak_absen.php" method="POST">
                                <div class="card-body">
                            ...
                            <!-- <a class="btn btn-success" role="button" target="_blank" href="data_absen.php">Excel</a> -->
                            <!-- <a class="btn btn-primary" role="button" target="_blank" href="pdf-absensi.php">PDF</a> -->
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" align="center">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = mysqli_query($conn, "select * from gaji_bulanan ");
                            ...
                            <!-- <br>
                            <a class="btn btn-success" role="button" target="_blank" href="data_gaji.php">Excel</a>
                            <a class="btn btn-primary" role="button" target="_blank" href="pdf-gaji.php">PDF</a> -->
