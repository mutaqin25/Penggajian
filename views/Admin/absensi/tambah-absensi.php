                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="../../../actions/tambah-absensi.php" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">Nik</label>
                                        <div class="col-sm-5">
                                            <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="nik">
                                                <option selected>Choose...</option>
                                                <?php $data = mysqli_query($conn, "select * from karyawan ");
                                                while ($d = mysqli_fetch_array($data)) {
                                                ?>
                                                    <option value="<?php echo $d['nik'] ?>"><?php echo $d['nik'] ?> / <?php echo $d['nama'] ?> / <?php echo $d['shift'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="date" name="tgl" required class="form-control" placeholder="Tanggal">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">Jam Masuk</label>
                                        <div class="col-sm-5">
                                            <input type="time" id="time" name="jam_masuk" class="form-control" placeholder="Jam Masuk">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="ket_masuk">
                                                ...
                                                <option value="Terlamabat">Terlambat</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="time" id="time" name="jam_keluar" class="form-control" placeholder="Jam Keluar">
                                        </div>
                                    </div>
                                    <div class="form-group row">
