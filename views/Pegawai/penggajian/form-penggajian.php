        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="../penggajian/form-penggajian.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Tabel Penggajian</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="number" readonly name="nik" required class="form-control" placeholder="Nik" value="<?php echo $d['nik'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Nama</label>
                                    <div class="col-sm-5">
                                        <input type="text" readonly name="nama" required class="form-control" placeholder="Nama" value="<?php echo $d['nama'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label pt-0">Jenis Kelamin</label>
                                    <div class="col-sm-5">
                                        <input type="text" readonly name="nama" required class="form-control" placeholder="Nama" value="<?php echo $d['jenis_kelamin'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Jabatan</label>
                                    <div class="col-sm-5">
                                        <input type="text" readonly name="nama" required readonly class="form-control" placeholder="Nama" value="<?php echo $d['jabatan'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Data Penggajian Perhari</h6>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" align="center">
                            ...
                            <tbody>
                                ...
                                $id = $_SESSION['nik'];
                                $no = 1;
                                $data = mysqli_query($conn, "select * from penghasilan where nik = $id ");
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" align="center">
                            ...
                            <tbody>
                                ...
                                $id = $_SESSION['nik'];
                                $no = 1;
                                $data = mysqli_query($conn, "select * from gaji_bulanan where nik = $id ");
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#hitung").click(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "../../../actions/hitung_gaji.php.php",
                    data: data,
                    success: function() {
